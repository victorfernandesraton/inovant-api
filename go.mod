module gitlab.com/falqon/inovantapp/backend
...
require (
	...
	github.com/pindamonhangaba/echo-swagger v0.0.0-20181019171417-76e3761bc591
	github.com/pindamonhangaba/hermes v1.2.0
